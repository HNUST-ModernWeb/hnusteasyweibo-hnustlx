...
CREATE TABLE `user`  (
                         ...
                         `user_type` tinyint(1) NULL DEFAULT 0 COMMENT '0普通用户 1管理员',
...
CREATE TABLE `post`  (
                         ...
                         `is_deleted` tinyint(1) NULL DEFAULT 0 COMMENT '0未删除',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '点赞表';
...
CREATE TABLE `tag`  (
                        ...
                        `tag_name` varchar(30) CHARACTER SET utf8mb4 NOT NULL COMMENT '标签名',
                        `is_deleted` tinyint(1) NULL DEFAULT 0 COMMENT '0未删除',
                        PRIMARY KEY (`tag_id`) USING BTREE,
                        UNIQUE INDEX `tag_name`(`tag_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '标签表';
